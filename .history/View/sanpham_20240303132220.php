  ...
  <section id="examples" class="text-center">
    ...
    <div class="row">
      <div class="col-md-7 mt-3 text-right">
        <?php
                if ($ac == 1) {
                    echo "<h3 class='mb- font-weight-bold' style='color: red'>TẤT CẢ SẢN PHẨM</h3>";
                }
                if ($ac == 2) {
                    echo "<h3 class='mb- font-weight-bold' style='color: red'>TẤT CẢ SẢN PHẨM SALE</h3>";
                }
                if ($ac == 3) {
                    echo "<h3 class='mb- font-weight-bold' style='color: red'>SẢN PHẨM TÌM KIẾM LÀ</h3>";
                }
             ?>
      </div>
