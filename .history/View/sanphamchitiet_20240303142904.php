      ...
      <div class="wrapper row">
        <form action="index.php?action=giohang&act=giohang_action" method="post">
          ...
          <div class="details col-md-6">
            ...
            <h4 class="product-title"><?php echo $tenhh ?></h4>
            <div class="rating">
              <div class="stars">
            ...
            <p style="margin-right:170px" class="product-description">
              <b>
                <?php
                  echo $mota;
                  ?>
            ...
            <h5 class="colors">Màu:
              <select class="mt-2" name="mymausac" class="form-control" style="width:150px;">
                <?php
              ...
              <?php
                ...
                ?>
              <br> <br>
              <span class="mt-2">Số Lượng:</span>
              <input type="number" id="soluong" name="soluong" min="1" max="100" value="1" size="10" / </h5>
