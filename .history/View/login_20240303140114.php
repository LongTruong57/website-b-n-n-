  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 login-sec">
        ...
        <form action="duanbangiay/index.php?action=dangnhap&act=dangnhap_action" class="form" role="form" method="post">
          ...
          <div class="form-check">
            <button class="btn btn-lg btn-primary" name="submit" btn-block type="submit"> Đăng Nhập</button>
