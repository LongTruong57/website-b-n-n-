...
<div class="container">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-5 well well-sm col-md-offset-4">
      ...
      <form action="DuAnMauindex.php?action=dangky&act=dangky_action" method="post" class="form" role="form">
        <div classDuAnMau/ <div class="col-xs-4 col-md-4"> <label for="email">Tên Khách Hàng:</label>
        </div>
    ...
    <button class="btn btn-lg btn-primary" name="submit" btn-block type="submit"> Đăng ký</button>
    </form>
  </div>
</div>
</div>