<div class="table-responsive">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Đơn Giá: <?php echo number_format($item['dongia']); ?> - Số Lượng: <input type="text" name="newqty[]" value="<?php echo $item['soluong'] ?>" /><br />
            <p style="float: right;"> Thành Tiền <?php echo number_format($item['thanhtien']); ?><sup><u>đ</u></sup></p>
          </td>
          <td><a href="index.php?action=giohang&act=delete_cart&id=<?php echo $key; ?>">
              <button type="button" class="btn btn-danger">Xóa</button></a>
          </td>
          <td><a href="index.php?action=giohang&act=upload_cart&id=<?php echo $key; ?>">
 ...
 ?>
  ...
  <?php
      ...
      echo '<script> alert("Bạn đang không có hàng trong giỏ!")</script>';
      echo '<meta http-equiv="refresh" content="0;URL=../duanbangiay/index.php?action=home"/>';
  }
 ?>
</div>