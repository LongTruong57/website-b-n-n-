      ...
      <div class="row">
        <nav class="navbar navbar-expand-lg n navbar-light bg-light" style="margin-bottom: 0px; ">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a href="/index.php?action=giohang" class="nav-link" style="margin-top:10px"><img src="./Content/imagetourdien/cartx2.png" width="30px" height="30px" alt=""></a>

            </li>
            <li class="nav-item">
              <p style="color: red; margin-top: 13px; margin-left: 0px;">(0)</p>
            </li>
            <?php
                            if (isset($_SESSION['makh'])){
                               echo
                                '<li>
                                    <p style="color: red; margin-top: 13px; margin-left: 0px;">'.$_SESSION['tenkh'].'</p>
                                </li>';
                            } else {
                            echo '
                            <li>
