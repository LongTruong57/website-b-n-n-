    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Đơn Giá: <?php echo number_format($item['dongia']); ?> - Số Lượng: <input type="number" name="newqty[]" value="<?php echo $item['soluong'] ?>" /><br />
          ...
          <td><a href="index.php?action=giohang&act=delete_cart&id=<?php echo $key; ?>">
            ...
            <a href="index.php?action=giohang&act=upload_cart&id=<?php echo $key; ?>">
