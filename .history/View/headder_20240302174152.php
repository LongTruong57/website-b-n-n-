        ...
        <nav class="navbar navbar-expand-lg n navbar-light bg-light" style="margin-bottom: 0px; ">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <?php
                            ...
                            ?>
            <li class="nav-item">
              <a href="DuAnMau/index.php?action=dangky" class="nav-link">Đăng Ký</a>
            </li>
            <li class="nav-item">
              <a href="DuAnMau/index.php?action=dangnhap" class="nav-link">Đăng Nhập</a>
            </li>
            <?php
                            }
                            ?>
            <li class="nav-item">
              <a href="DuAnMau/index.php?action=dangnhap&act=dangxuat" class="nav-link">Đăng Xuất</a>
            </li>
            <li>
              <a href="DuAnMau/index.php?action=giohang" class="nav-link"><img src="./Content/imagetourdien/cartx2.png" width="30px" height="30px" alt=""></a>
